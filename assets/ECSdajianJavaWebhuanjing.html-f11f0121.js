import{_ as i,p as l,q as o,s as n,R as s,t as e,Y as t,n as c}from"./framework-e1bed10d.js";const r={},d=t(`<h2 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备" aria-hidden="true">#</a> 环境准备</h2><h3 id="免费创建一台临时服务器" tabindex="-1"><a class="header-anchor" href="#免费创建一台临时服务器" aria-hidden="true">#</a> 免费创建一台临时服务器</h3><img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200810084202.png"><h3 id="ssh登陆" tabindex="-1"><a class="header-anchor" href="#ssh登陆" aria-hidden="true">#</a> SSH登陆</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ssh</span> username@ip
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200810084455.png">`,6),p={class:"custom-container tip"},m=n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M12 8h.01"}),n("path",{d:"M11 12h1v4h1"})])],-1),u=n("p",{class:"custom-container-title"},"SSH",-1),v=n("br",null,null,-1),h=n("br",null,null,-1),k={href:"http://blog.ikarosx.cn/docs/views/Web/2020/08/SSH%E7%94%A8%E6%88%B7%E8%AE%A4%E8%AF%81.html",target:"_blank",rel:"noopener noreferrer"},b=t(`<h3 id="安装jdk" tabindex="-1"><a class="header-anchor" href="#安装jdk" aria-hidden="true">#</a> 安装JDK</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看yum源中JDK版本</span>
yum list java*
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200810091209.png">`,3),g={href:"https://stackoverflow.com/questions/22358071/differences-between-oracle-jdk-and-openjdk?r=SearchResults",target:"_blank",rel:"noopener noreferrer"},y=t(`<h3 id="安装mysql" tabindex="-1"><a class="header-anchor" href="#安装mysql" aria-hidden="true">#</a> 安装mysql</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装wget下载mysql官方的Yum Repository</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="访问tomcat" tabindex="-1"><a class="header-anchor" href="#访问tomcat" aria-hidden="true">#</a> 访问Tomcat</h3><p>由于配置了Tomcat端口为80，所以直接输入IP即可访问</p><img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200810102109.png"><h3 id="脚本" tabindex="-1"><a class="header-anchor" href="#脚本" aria-hidden="true">#</a> 脚本</h3>`,8),_={href:"https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/ECS_java_web_env_install.sh",target:"_blank",rel:"noopener noreferrer"},f=n("br",null,null,-1);function x(q,w){const a=c("ExternalLinkIcon");return l(),o("div",null,[d,n("div",p,[m,u,n("p",null,[s("SSH可以配置证书登陆"),v,s(" 其中我们在初次访问时有指纹确认，这个是为了防止中间人攻击"),h,s(" 详情可以参考我的另一篇博客"),n("a",k,[s("SSH用户认证"),e(a)])])]),b,s(" 可以看到目前openjdk8版本是8u262 而查了一下目前oracle jdk8最新是8u261 这也不难理解，oracle jdk是基于open jdk编写的 "),n("p",null,[s("更多OracleJDK和OpenJDK可以查看"),n("a",g,[s("StackOverFlow"),e(a)])]),y,n("p",null,[s("为了简便起见我写了一个简单的"),n("a",_,[s("脚本"),e(a)]),f,s(" 脚本没有实现更改mysql密码")])])}const j=i(r,[["render",x],["__file","ECSdajianJavaWebhuanjing.html.vue"]]);export{j as default};
