...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),d=n("div",{class:"custom-container danger"},[n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M10 10l4 4m0-4l-4 4"})])]),n("p",{class:"custom-container-title"},"echo"),n("p",null,[n("code",null,"echo '# Hello VuePress!' > README.md"),n("br"),s(" 执行这句之后，运行访问出现乱码，这是因为默认PowerShell选择UTF-16编码"),n("br"),s(" 执行下面这句将编码指定为UTF-8"),n("br"),n("code",null,"$PSDefaultParameterValues['Out-File:Encoding'] = 'utf8'")])],-1),u=a(`<p>运行完出现的应该就是下面这样子</p><img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200805192219.png" style="box-shadow:1px 1px 20px #888888;"><h3 id="添砖加瓦" tabindex="-1"><a class="header-anchor" href="#添砖加瓦" aria-hidden="true">#</a> 添砖加瓦</h3><p>这是基本的目录结构，当我们使用 <code>vuepress dev docs</code> 所有的访问路径都是基于docs文件夹</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">.</span>  
├── docs  
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200805212828.png" style="box-shadow:1px 1px 20px #888888;"><img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200805212901.png" style="box-shadow:1px 1px 20px #888888;"><h2 id="reco主题" tabindex="-1"><a class="header-anchor" href="#reco主题" aria-hidden="true">#</a> Reco主题</h2>`,14),v=n("div",{class:"custom-container tip"},[n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M12 8h.01"}),n("path",{d:"M11 12h1v4h1"})])]),n("p",{class:"custom-container-title"},"主题"),n("p",null,[s("如果你和我一样不擅长前端开发的话"),n("br"),s(" 使用现成的主题也不失为一个好的方案"),n("br"),s(" 这里选择了Reco")])],-1),m=a(`<h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 全局安装reco提供的cli工具，比较方便</span>
...
theme-cli init
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),k=n("div",{class:"custom-container tip"},[n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M12 8h.01"}),n("path",{d:"M11 12h1v4h1"})])]),n("p",{class:"custom-container-title"},"theme-cli无法找到"),n("p",null,[s("没有配置npm全局包的环境变量"),n("br"),s(" npm config list查看prefix =后面的值"),n("br"),s(" 将其加入环境变量即可")])],-1),b=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 进入你刚刚创建的文件夹</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行起来之后就能看到跟我这个博客一样的界面了</p><h3 id="配置" tabindex="-1"><a class="header-anchor" href="#配置" aria-hidden="true">#</a> 配置</h3>`,5),h=n("code",null,".vuepress/config.js",-1),g=n("br",null,null,-1),x={href:"https://www.vuepress.cn/guide",target:"_blank",rel:"noopener noreferrer"},w={href:"https://vuepress-theme-reco.recoluan.com/views/1.x/",target:"_blank",rel:"noopener noreferrer"},_=n("h3",{id:"采坑",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#采坑","aria-hidden":"true"},"#"),s(" 采坑")],-1),y=n("h4",{id:"热加载",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#热加载","aria-hidden":"true"},"#"),s(" 热加载")],-1),f=n("br",null,null,-1),M={href:"https://github.com/vuejs/vuepress/issues/221",target:"_blank",rel:"noopener noreferrer"},j=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>vuepress dev <span class="token builtin class-name">.</span> <span class="token parameter variable">--host</span> localhost
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,1),E=n("div",{class:"custom-container warning"},[n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M12 8v4"}),n("path",{d:"M12 16h.01"})])]),n("p",{class:"custom-container-title"},"WARNING"),n("p",null,[s("注意不能写在package.json的script里，无法生效"),n("br"),s(" 要直接运行vuepress dev . --host localhost")])],-1),V=a(`<h4 id="build" tabindex="-1"><a class="header-anchor" href="#build" aria-hidden="true">#</a> build</h4><p>我还在想build之后我们是如何更新新的文章<br> 结果发现其实需要我们手动去替换新生成的文件<br> 这里我们可以使用脚本来解决</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># upload.sh</span>
...
<span class="token function">scp</span> <span class="token parameter variable">-r</span> blog root@ikarosx.cn:/usr/share/nginx/yps/html/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),I=n("br",null,null,-1),R={href:"https://www.vuepress.cn/guide/deploy.html#github-pages",target:"_blank",rel:"noopener noreferrer"},A=n("div",{class:"custom-container tip"},[n("svg",{xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 24 24"},[n("g",{fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"},[n("circle",{cx:"12",cy:"12",r:"9"}),n("path",{d:"M12 8h.01"}),n("path",{d:"M11 12h1v4h1"})])]),n("p",{class:"custom-container-title"},"scp乱码"),n("p",null,[s("更改为git带的scp命令"),n("br"),s(" 可以用Get-Command查看命令地址，类似于which"),n("br"),s(" 2021-2-20 22:22:51更新")])],-1),B=n("h3",{id:"插件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#插件","aria-hidden":"true"},"#"),s(" 插件")],-1),C={href:"https://valine.js.org/vuepress.html",target:"_blank",rel:"noopener noreferrer"},D={href:"https://github.com/vuepress-reco/vuepress-plugin-bgm-player",target:"_blank",rel:"noopener noreferrer"},P=a(`<img src="https://ikaros-picture.oss-cn-shenzhen.aliyuncs.com/typora/Ikaros/20200805213501.png" style="box-shadow:1px 1px 20px #888888;"><p>下面是我的配置文件</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token literal-property property">plugins</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token punctuation">[</span>
    ...
    <span class="token punctuation">]</span>
  <span class="token punctuation">]</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function T(z,L){const e=c("ExternalLinkIcon");return t(),o("div",null,[r,d,u,v,m,k,b,n("p",null,[s("主要是针对"),h,s("的修改"),g,n("a",x,[s("官网"),i(e)]),s("和"),n("a",w,[s("主题"),i(e)]),s("的文档都非常详细，建议参考官方文档")]),_,y,n("p",null,[s("启动之后一直无法热加载，网上说的是md文件可以，config.js不行 但我md文件也不行"),f,s(" 最后在"),n("a",M,[s("issue"),i(e)]),s("上找到了答案")]),j,E,V,n("p",null,[s("我用这种做法是因为我是将网站部署在自己的云服务器"),I,s(" 如果你是部署在github可以参考"),n("a",R,[s("官方"),i(e)])]),A,B,n("p",null,[s("有很多好用的插件,比如"),n("a",C,[s("评论"),i(e)]),s("、"),n("a",D,[s("背景音乐"),i(e)])]),P])}const H=l(p,[["render",T],["__file","dajianvuepress.html.vue"]]);export{H as default};
