import{_ as n,p as s,q as a,Y as e}from"./framework-e1bed10d.js";const t={},i=e(`<h2 id="起因" tabindex="-1"><a class="header-anchor" href="#起因" aria-hidden="true">#</a> 起因</h2><p>有时候我们可能想把多个仓库合并在一起</p><p>比如一个前端一个后端</p><p>但由于创建时没想太多</p><p>所以需要弥补一下</p><h2 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h2><p>现在有A仓库和B仓库</p><p>我们想把A和B合并在C</p><p>A仓库的内容放在C/A文件夹下</p><p>B仓库的内容放在C/B文件夹下</p><h3 id="创建c仓库" tabindex="-1"><a class="header-anchor" href="#创建c仓库" aria-hidden="true">#</a> 创建C仓库</h3><p>在github上操作一下创建仓库</p><p>本地拉取下来</p><p><code>git clone c.git</code></p><h3 id="合并a仓库" tabindex="-1"><a class="header-anchor" href="#合并a仓库" aria-hidden="true">#</a> 合并A仓库</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 在C仓库下添加A仓库的git地址</span>
